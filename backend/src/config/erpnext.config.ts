...
export const ERPNEXT_READ_OPERATIONS = [
  ...
  ERPNEXT_DOCTYPES.PURCHASE_INVOICE,
  ERPNEXT_DOCTYPES.PAYMENT_ENTRY,
  ERPNEXT_DOCTYPES.JOURNAL_ENTRY,

  // Inventory & Stocks
  ERPNEXT_DOCTYPES.ITEM,
  ERPNEXT_DOCTYPES.MATERIAL_REQUEST,
  ERPNEXT_DOCTYPES.STOCK_ENTRY,
  ERPNEXT_DOCTYPES.WAREHOUSE,

  // CRM & Projects
  ERPNEXT_DOCTYPES.LEAD,
  ERPNEXT_DOCTYPES.OPPORTUNITY,
  ERPNEXT_DOCTYPES.PROJECT,
  ERPNEXT_DOCTYPES.TASK,

  // HR & Payroll
  ERPNEXT_DOCTYPES.EMPLOYEE,
  ERPNEXT_DOCTYPES.ATTENDANCE,
  ERPNEXT_DOCTYPES.SALARY_SLIP,
  ERPNEXT_DOCTYPES.PAYROLL_ENTRY,

  // Manufacturing
  ERPNEXT_DOCTYPES.WORK_ORDER,
  ERPNEXT_DOCTYPES.BILL_OF_MATERIALS,
  ERPNEXT_DOCTYPES.PRODUCTION_PLAN,

  // Logistics & Shipping
  ERPNEXT_DOCTYPES.SHIPMENT,
  ERPNEXT_DOCTYPES.DELIVERY_NOTE,

  // Quality Control
  ERPNEXT_DOCTYPES.QUALITY_INSPECTION,
  ERPNEXT_DOCTYPES.QUALITY_PROCEDURE,
